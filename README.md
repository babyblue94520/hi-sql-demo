    ...
    * **SQL** 表達式
        ...
        * 參數
          ...
          **Repository**
          ...
          public interface QueryRepository extends SQLRepository {
              @HiSql(query = "select * from table where column1 = :value1 and column2 = :value2")
              List query(String value1, String value2);
          
              // where in
              @HiSql(query = "select * from table where column1 in :values1 and column2 in :values2")
        ...
        * 動態語法
          ...
          **Repository**
            ...
            @Repository
            public interface QueryRepository extends SQLRepository {
                @HiSql(query = "select * from table where 1=1 {and1} {and2}")
...
* 配置 **XML SQL**
    ...
    * 依照 **Method Name** or **@HiSql(name=...)** 載入對應的標籤名稱
    * 方便複雜的 **SQL** 排版
